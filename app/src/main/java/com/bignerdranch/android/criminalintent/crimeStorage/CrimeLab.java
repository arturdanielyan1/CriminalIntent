...
public class CrimeLab {
    ...
    private static List<Crime> getCrimesStatic() {
    ...
    public void deleteCrime(Crime crime){
        ...
        /**why third argument is an array**/
    }

    public List<Crime> getCrimes() {
        return getCrimesStatic();
    }

    public int getCrimePosition(Crime crime) {
        List<Crime> crimes = getCrimesStatic();
    ...
    public void updateCrime(Crime crime){
        ...
        mDatabase.update(CrimeTable.NAME, values,
                CrimeTable.Cols.UUID + " = ?",/**if this is null then the 4rth argument must be null too?**/
                new String[] {uuidString});
    }

    private static CrimeCursorWrapper queryCrimes(String whereClause, String[] whereArgs) {
